...
module.exports = { session: process.env.SESSION_ID || 'steph',
    PREFIXE: process.env.PREFIX || "+",
    GITHUB : process.env.GITHUB|| 'https://github.com/Keithkeizzah/ALPHA-MD',
    OWNER_NAME : process.env.OWNER_NAME || "STE_PHANE_",
    NUMERO_OWNER : process.env.NUMERO_OWNER || "237699320631",  
   ...
   GREET_MSG: process.env.GREET_MSG || "Huskii am unavailable mzee 😂",               
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || 'viewed by stephan',   
    AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || 'no',
    AUTOBIO: process.env.AUTOBIO || 'yes',       
    ANTICALL_MSG : process.env.ANTICALL_MSG || 'call declined',             
    GURL: process.env.GURL  || "https://whatsapp.com/channel/0029Vaan9TF9Bb62l8wpoD47",
    EVENTS :process.env.EVENTS || "yes",
    CAPTION : process.env.CAPTION || "BOYCE",
    BOT : process.env.BOT_NAME || 'BOYCE',
